...
This standard governs exception capture only. If the task also changes public return signatures, apply [Neverthrow Return Types](neverthrow-return-types.md) alongside this standard.
